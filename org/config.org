...
**** Yesterday & Today
     ...
     #+BEGIN_SRC emacs-lisp
       (add-to-list
        'org-agenda-custom-commands
        '("y" "Yesterday and Today"
          ((agenda "Yesterday and Today"
                   ((org-agenda-span (pcase (calendar-day-of-week (calendar-current-date))
                                       (1 4) ; Show Friday
                                       (0 3) ; Show Friday
                                       (_ 2)))
                    (org-agenda-start-day
         ...
         #+BEGIN_SRC emacs-lisp
           (setq org-capture-templates
                 '(("c" "Contacts" entry (file "~/org/contacts.org")
                   ...
                   ("t" "To do" entry (file+datetree org-default-notes-file)
                    "* TODO %?\n%^{Owner}p\n%U\n%a\n" :empty-lines-after 1)))
     #+END_SRC
