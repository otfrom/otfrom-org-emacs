...
****** What am I doing in the Current Cake Countdown?
       ...
       It is *supposed* to skip todo items that have a deadline marked
       as I have them already in the agenda at the top. It also
       overrides the text that describes the todo list. By default it
       is the regular expression we are using to filter the todo
       list.
