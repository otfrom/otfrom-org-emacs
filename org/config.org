...
***** The usual help keybinding
      ...
      #+BEGIN_SRC emacs-lisp
        (add-hook 'emacs-lisp-mode-hook
                  (lambda () (local-set-key (kbd "C-c C-d") 'describe-function-in-popup)))
      #+END_SRC
...
*** emms keybindings
    ...
    #+BEGIN_SRC emacs-lisp
      (global-set-key (kbd "C-M-<f8>") 'emms-playlist-mode-go)
