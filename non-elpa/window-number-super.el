...
;; with changes from Bruce Durling
;; <bld@otfrom.com> in 2012
...
;; (autoload 'window-number-super-mode "window-number"
;;   "A global minor mode that enables use of the s- prefix to select
;; windows, use `window-number-mode' to display the window numbers in
;; the mode-line."
;;   t)
...
(defvar window-number-super-mode-map nil
  "Keymap for the window number super mode.")
...
; define M-1 to switch to win 1, etc (M-0 = win 10)
(unless window-number-super-mode-map
  (setq window-number-super-mode-map (make-sparse-keymap))
  (window-number-define-keys window-number-super-mode-map "s-"))
...
(define-minor-mode window-number-super-mode
  "A global minor mode that enables use of the s- prefix to
select windows, use `window-number-mode' to display the window
numbers in the mode-line."
  :global t
  :init-value nil)
